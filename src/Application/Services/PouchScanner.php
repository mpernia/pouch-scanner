...
class PouchScanner implements PouchScannerInterface
{
    ...
    public function getInProgressRolls(int $daysBack = 250): ?RollCollection
    {
    ...
    public function getFinalizedRolls(int $daysBack = 250): ?RollCollection
    {
    ...
    public function getRoll(int|string $rollId): ?Roll
    {
        ...
        $roll = new RollDto(
            patientRoll: $rollId,
            batchId: $attributes?->batchId ?? null,
